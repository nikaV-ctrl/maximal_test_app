...
FollowersEntity _$FollowersEntityFromJson(Map<String, dynamic> json) {
  return _FollowersEntity.fromJson(json);
}

/// @nodoc
mixin _$FollowersEntity {
  ...
  @JsonKey(ignore: true)
  $FollowersEntityCopyWith<FollowersEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FollowersEntityCopyWith<$Res> {
  factory $FollowersEntityCopyWith(
          FollowersEntity value, $Res Function(FollowersEntity) then) =
      _$FollowersEntityCopyWithImpl<$Res, FollowersEntity>;
  @useResult
  $Res call(
      {String login,
      int id,
...
/// @nodoc
class _$FollowersEntityCopyWithImpl<$Res, $Val extends FollowersEntity>
    implements $FollowersEntityCopyWith<$Res> {
  _$FollowersEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FollowersEntityImplCopyWith<$Res>
    implements $FollowersEntityCopyWith<$Res> {
  factory _$$FollowersEntityImplCopyWith(_$FollowersEntityImpl value,
          $Res Function(_$FollowersEntityImpl) then) =
      __$$FollowersEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String login,
...
/// @nodoc
class __$$FollowersEntityImplCopyWithImpl<$Res>
    extends _$FollowersEntityCopyWithImpl<$Res, _$FollowersEntityImpl>
    implements _$$FollowersEntityImplCopyWith<$Res> {
  __$$FollowersEntityImplCopyWithImpl(
      _$FollowersEntityImpl _value, $Res Function(_$FollowersEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FollowersEntityImpl(
      login: null == login
          ? _value.login
          : login // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$FollowersEntityImpl implements _FollowersEntity {
  const _$FollowersEntityImpl(
      {required this.login,
      required this.id,
  ...
  factory _$FollowersEntityImpl.fromJson(Map<String, dynamic> json) =>
      _$$FollowersEntityImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FollowersEntityImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FollowersEntityImplCopyWith<_$FollowersEntityImpl> get copyWith =>
      __$$FollowersEntityImplCopyWithImpl<_$FollowersEntityImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FollowersEntityImplToJson(
      this,
    );
  }
}

abstract class _FollowersEntity implements FollowersEntity {
  const factory _FollowersEntity(
      ...
      required final bool siteAdmin}) = _$FollowersEntityImpl;

  factory _FollowersEntity.fromJson(Map<String, dynamic> json) =
      _$FollowersEntityImpl.fromJson;
